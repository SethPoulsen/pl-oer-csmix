...
##########################
# INIT, this is for DDL, alsmost the same as runSP.sh (for stored procedure)
##########################
...
BASE_GRADER=$JOB_DIR'serverFilesCourse/grader/'
...
bash -c 'python3 -m sql_grader_main "ddl"'
